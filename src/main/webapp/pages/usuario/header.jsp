...
<header>
	...
	<nav>
		<%
            if (usuarioLogado != null) {
                if ("ADMIN".equalsIgnoreCase(usuarioLogado.getTipo().name())) {
        %>
                    <a href="<%= request.getContextPath() %>/pages/admin/dashboardAdmin.jsp">Dashboard</a>
                    <a href="<%= request.getContextPath() %>/pages/admin/gerenciarUsuarios.jsp">Gerenciar Usuários</a>
                    <a href="<%= request.getContextPath() %>/pages/admin/gerenciarUnidades.jsp">Gerenciar Unidades</a>
                    <a href="<%= request.getContextPath() %>/pages/admin/gerenciarContratos.jsp">Gerenciar Contratos</a>
        <%
                } else { // usuário normal
        %>
        ...
        <%
            ...
            } else { // visitante não logado
        %>
                    <a href="<%= request.getContextPath() %>/pages/outros/sobre.jsp">Sobre</a>
                    <a href="<%= request.getContextPath() %>/pages/outros/funcionalidades.jsp">O que oferecemos</a>
                    <a href="<%= request.getContextPath() %>/pages/outros/contato.jsp">Contato</a>
        <%
            }
        %>
    ...
    %>
	<div class="user-info">
		<span class="user-welcome">Olá, <%= usuarioLogado.getNome() %>!</span>
