...
<main aria-label="Cadastrar novo documento">
    ...
    <form action="<%= request.getContextPath() %>/DocumentoController" method="post">
        ...
        <input type="datetime-local" id="dataDocumento" name="dataDocumento" required value="<%= dataHoraFormatada %>" />

        <label for="arquivo">Nome do arquivo (upload deve ser implementado depois):</label>
        <input type="text" id="arquivo" name="arquivo" maxlength="255" placeholder="ex: relatorio1.pdf" />
