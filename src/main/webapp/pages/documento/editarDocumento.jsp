...
<main aria-label="Editar Documento">
    ...
    <form action="<%= request.getContextPath() %>/DocumentoController" method="post" novalidate>
        ...
        <label for="arquivo">Caminho/URL do Arquivo</label>
        <input type="text" id="arquivo" name="arquivo" value="<%= documento.getArquivo() != null ? documento.getArquivo() : "" %>" />
