...
<body class="pagina-detalhes-contrato">
	...
	<main aria-label="Detalhes do contrato">
		...
		<form
			action="<%= request.getContextPath() %>/pages/contrato/editarContrato.jsp"
		...
		<form action="<%= request.getContextPath() %>/ContratoController"
			...
			<button type="submit" class="btn btn-delete">Deletar
				Contrato</button>
		</form>
		...
		<div class="card">
			...
			<div class="info">
				<span class="info-label">Status do Contrato:</span><span
					class="info-value"><%= contrato.getStatusContrato() != null ? contrato.getStatusContrato() : "-" %></span>
			</div>
			<div class="info">
			...
			<table class="documentos">
				...
				<tbody>
					...
					<tr>
						...
						<td><%= doc.getArquivo() != null && !doc.getArquivo().isEmpty() ? doc.getArquivo() : "-" %></td>
						<td>
							<form
